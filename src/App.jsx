...
function AuthScreen({onAuth}) {
  ...
  return(
    <div style={{minHeight:"100vh",background:C.bg,display:"flex",fontFamily:"'SF Pro Text',-apple-system,sans-serif"}}>
      <div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",padding:"40px 32px",background:C.bg}}>
        <div style={{textAlign:"center",maxWidth:420}}>
          <img src={TALON_LOGO} alt="TALON" style={{width:"100%",maxWidth:520,objectFit:"contain",display:"block",margin:"0 auto"}}/>
        </div>
      </div>
      <div style={{width:"100%",maxWidth:440,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"40px 32px",borderLeft:`1px solid ${C.border}`}}>
        <div style={{width:"100%",marginBottom:24,textAlign:"center"}}>
          <div style={{fontSize:40,fontWeight:100,letterSpacing:"0.55em",color:"#fff",fontFamily:"'Josefin Sans',sans-serif",textTransform:"uppercase",marginBottom:4,textShadow:"0 0 40px rgba(201,162,39,0.15)"}}>TALON</div>
    ...
    <div style={{minHeight:"100vh",background:C.bg,color:C.text,fontFamily:"'SF Pro Text',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif"}}>
      ...
      <div style={{background:C.nav,borderBottom:`1px solid ${C.border}`,padding:"8px 18px",display:"flex",alignItems:"center",justifyContent:"space-between",position:"sticky",top:0,zIndex:10}}>
        <div style={{display:"flex",alignItems:"center",gap:8}}>
          <img src={TALON_LOGO} alt="TALON" style={{width:40,height:40,objectFit:"contain"}}/>
          <div>
            <span style={{fontSize:15,fontWeight:300,letterSpacing:"0.38em",color:"#ffffff",fontFamily:"'Josefin Sans',sans-serif",textTransform:"uppercase",display:"block",lineHeight:1.1}}>TALON</span>
            <span style={{fontSize:7,color:C.gold,display:"block",letterSpacing:"0.12em",marginTop:1}}>LOGANTIA.AI</span>
          </div>
        </div>
