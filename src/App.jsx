...
// ─── Supabase Client ──────────────────────────────────────────────────────────
const SUPA_URL = "https://opjukxysiazgufezarci.supabase.co";
const SUPA_KEY = "sb_publishable_F8rus4ktSri3Zpur8zhfsA_-Bo95-a9";
...
const OB=[
  {title:"What's your TALON Score?",sub:"5 questions. 60 seconds. You'll get a personalized financial score, a custom roadmap, and find out exactly where you stand with money.",fields:[{key:"name",label:"First name",type:"text",ph:"What should TALON call you?"},{key:"age",label:"Age range",type:"sel",opts:[["20s","20-29"],["30s","30-39"],["40s","40-49"],["50s","50-59"],["60s","60+"]]}]},
  {title:"Money in, money out",sub:"No judgment. This is just between you and TALON. The more accurate you are the more powerful your score.",fields:[{key:"income",label:"Annual household income",type:"sel",opts:[["u25k","Under $25,000"],["25-50k","$25,000-$50,000"],["50-75k","$50,000-$75,000"],["75-150k","$75,000-$150,000"],["150k+","$150,000+"]]},{key:"debt",label:"Current debt situation",type:"sel",opts:[["none","Debt-free"],["low","Minimal (under $10k)"],["moderate","Manageable ($10k-$40k)"],["heavy","Heavy ($40k-$100k)"],["severe","Overwhelming ($100k+)"]]}]},
  {title:"Protection and the future",sub:"This is where most people are completely exposed and don't know it. Let's find out where you stand.",fields:[{key:"ef",label:"Emergency fund",type:"sel",opts:[["none","None — fully exposed"],["partial","Under 1 month"],["1mo","1 month"],["3mo","3 months"],["6mo","6 months"],["12mo+","12+ months"]]},{key:"retireSaving",label:"Actively saving for retirement?",type:"sel",opts:[["no","Not yet"],["yes","Yes — 401k, IRA, or both"]]}]},
  {title:"One last thing",sub:"This is how TALON personalizes everything — your score, your roadmap, your coaching. 10 seconds and we're done.",fields:[{key:"knowledge",label:"Financial knowledge level",type:"sel",opts:[["beginner","Beginner — learning basics"],["some","Some experience"],["intermediate","Intermediate — I invest"],["advanced","Advanced — active management"]]},{key:"email",label:"Email for free newsletter (optional)",type:"text",ph:"your@email.com"}]},
];
