...
const TALON_WORDMARK = "data:image/svg+xml;base64,";
const LOAD_MSGS = [
    ...
    <div style={{minHeight:"100vh",background:C.bg,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:"'SF Pro Text',-apple-system,sans-serif",padding:"24px 20px"}}>
      <div style={{width:"100%",maxWidth:420}}>
        <div style={{textAlign:"center",marginBottom:24}}>
          <img src={TALON_WORDMARK} alt="TALON" style={{height:48,width:"auto",marginBottom:8}}/>
          <div style={{fontSize:9,color:C.gold,letterSpacing:"0.18em"}}>POWERED BY LOGANTIA.AI</div>
        </div>
      <div style={{width:"100%"}}>
    ...
    <div style={{minHeight:"100vh",background:C.bg,color:C.text,fontFamily:"'SF Pro Text',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif"}}>
      ...
      <div style={{background:C.nav,borderBottom:`1px solid ${C.border}`,padding:"8px 18px",display:"flex",alignItems:"center",justifyContent:"space-between",position:"sticky",top:0,zIndex:10}}>
        <div style={{display:"flex",alignItems:"center",gap:8}}>
          <img src={TALON_LOGO} alt="TALON" style={{height:48,width:48,objectFit:"contain",objectPosition:"center"}}/>
        </div>
